...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@starcode/shared/git`, `@starcode/shared/DrainableWorker`) — no barrel index.

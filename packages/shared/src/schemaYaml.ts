 ...
 *
 * ```ts
 * import { parseYaml } from "@starcode/shared/schemaYaml"
 *
 ...
 *
 * ```ts
 * import { stringifyYaml } from "@starcode/shared/schemaYaml"
 *
 ...
 * ```ts
 * import * as Schema from "effect/Schema"
 * import { fromYamlString } from "@starcode/shared/schemaYaml"
 *

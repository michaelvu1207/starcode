...
>()("@starcode/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@starcode/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@starcode/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@starcode/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}

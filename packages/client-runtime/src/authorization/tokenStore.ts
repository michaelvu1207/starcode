...
import { RelayManagedEndpoint } from "@starcode/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@starcode/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@starcode/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}

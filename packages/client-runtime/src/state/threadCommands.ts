...
import {
  ...
  type StartThreadAgentTurnInput,
  type InterruptThreadAgentTurnInput,
  ...
  deleteThread,
  interruptThreadTurn,
  startThreadAgentTurn,
  interruptThreadAgentTurn,
...
export type {
  ...
  StartThreadAgentTurnInput,
  InterruptThreadAgentTurnInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    startAgentTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:start-agent-turn",
      execute: (input: StartThreadAgentTurnInput) => startThreadAgentTurn(input),
      scheduler,
      concurrency,
    }),
    interruptAgentTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:interrupt-agent-turn",
      execute: (input: InterruptThreadAgentTurnInput) => interruptThreadAgentTurn(input),
      scheduler,
      concurrency,
    }),

...
import { StarcodeProjectFile } from "./starcodeProjectFile.ts";

const decode = Schema.decodeUnknownSync(StarcodeProjectFile);

describe("StarcodeProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://t3.codes/schema/starcode.json",

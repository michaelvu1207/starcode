...
const rule = createOxlintRuleHarness("starcode/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("starcode/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("starcode/no-manual-effect-runtime-in-tests");

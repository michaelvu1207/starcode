import type { RelayDeviceRegistrationRequest } from "@starcode/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "com.starcode.starcode.preview" as RelayDeviceRegistrationRequest["bundleId"],

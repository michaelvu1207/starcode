  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new starcode prerelease is available for nightly testers."
          : "A new starcode latest release is available.",
...
).pipe(Command.withDescription("Post a starcode release announcement to Discord."));

...
const latestAnnouncement = {
  ...
  releaseName: "starcode v1.2.3",
  version: "1.2.3",
  tag: "v1.2.3",
  releaseUrl: new URL("https://github.com/t3dotgg/starcode/releases/tag/v1.2.3"),
...
it("builds a prerelease Discord announcement for nightly subscribers", () => {
  assert.deepStrictEqual(
    buildDiscordReleaseAnnouncement({
      ...
      releaseName: "starcode Nightly 1.2.4-nightly.20260501.17 (abcdef123456)",
      version: "1.2.4-nightly.20260501.17",
      tag: "v1.2.4-nightly.20260501.17",
      releaseUrl: new URL(
        "https://github.com/t3dotgg/starcode/releases/tag/v1.2.4-nightly.20260501.17",
      ),
      timestamp: "2026-05-01T01:41:00.000Z",
    }),
    {
      content:
        "<@&111111111111111111> Prerelease published: starcode Nightly 1.2.4-nightly.20260501.17 (abcdef123456)",
      allowed_mentions: {
        roles: ["111111111111111111"],
      },
      embeds: [
        {
          title: "starcode Nightly 1.2.4-nightly.20260501.17 (abcdef123456)",
          url: "https://github.com/t3dotgg/starcode/releases/tag/v1.2.4-nightly.20260501.17",
          description: "A new starcode prerelease is available for nightly testers.",
          color: 0x5865f2,
          fields: [
            {
              name: "Version",
...
it("builds a latest Discord announcement for stable subscribers", () => {
  assert.deepStrictEqual(buildDiscordReleaseAnnouncement(latestAnnouncement), {
    content: "<@&222222222222222222> Latest published: starcode v1.2.3",
    allowed_mentions: {
      roles: ["222222222222222222"],
    },
    embeds: [
      {
        title: "starcode v1.2.3",
        url: "https://github.com/t3dotgg/starcode/releases/tag/v1.2.3",
        description: "A new starcode latest release is available.",
        color: 0x2ecc71,
        fields: [
          {
            name: "Version",

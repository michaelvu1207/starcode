...
import type { EnvironmentCloudLinkStateResult } from "@starcode/contracts";
...
export function usePrimaryCloudLinkState() {
  ...
  if (result._tag === "Failure") {
    ...
    error = cause instanceof Error ? cause.message : "Could not read starcode Connect link state.";
  }

...
import { RelayWebClientId } from "@starcode/contracts/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_STARCODE_RELAY_URL", "https://relay.example.test");

...
const PIERRE_ICON_SPRITE_ID = "starcode-pierre-file-icon-sprite";

const STARCODE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="starcode-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="starcode-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="starcode-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="starcode-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="starcode-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="starcode-file-icon-pnpm" viewBox="0 0 32 32">
...
export const STARCODE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: STARCODE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "starcode-file-icon-package-json",
    "tsconfig.json": "starcode-file-icon-tsconfig",
    "agents.md": "starcode-file-icon-agents",
    "claude.md": "starcode-file-icon-claude",
    "readme.md": "starcode-file-icon-readme",
    "pnpm-lock.yaml": "starcode-file-icon-pnpm",
    "pnpm-workspace.yaml": "starcode-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(STARCODE_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${STARCODE_FILE_ICON_SPRITE}`;

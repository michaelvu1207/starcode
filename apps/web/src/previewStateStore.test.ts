import { scopedThreadKey, scopeThreadRef } from "@starcode/client-runtime/environment";
import { type EnvironmentId, type PreviewSessionSnapshot, ThreadId } from "@starcode/contracts";

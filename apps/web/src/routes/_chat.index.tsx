...
import { EmptyStateSky, SkySpecks } from "../components/brand/CelestialArt";
  ...
  return (
    <SidebarInset className="h-dvh min-h-0 overflow-hidden overscroll-y-none bg-background text-foreground">
      <div className="relative flex min-h-0 min-w-0 flex-1 flex-col overflow-x-hidden bg-background">
        <SkySpecks className="text-foreground" />
        <Empty className="relative flex-1">
          <div className="w-full max-w-lg px-8 py-12">
            <EmptyHeader className="max-w-none">
              <EmptyStateSky className="mx-auto mb-4 size-8" />
          ...
          <div className="w-full max-w-xl rounded-3xl border border-border/55 bg-card/20 px-8 py-12 shadow-sm/5">
            <EmptyHeader className="max-w-none">
              ...
              <EmptyDescription className="mt-2 text-sm leading-relaxed text-muted-foreground/78">
                {cloudEnabled
                  ? "Sign in to starcode Connect to connect a linked environment through its managed tunnel, or add a reachable backend manually."

 ...
 * row already knows.
 *
 * The agent has to be one that can fork a *session*. Pi's
 * `SessionManager.forkFrom` reads the source and writes a distinct transcript,
 * which is the property that matters. Retired driver cursors are not aliases
 * for Pi and must stay setup-only.
 *

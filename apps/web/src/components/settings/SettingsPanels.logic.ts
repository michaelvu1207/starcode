...
import { DEFAULT_UNIFIED_SETTINGS } from "@starcode/contracts/settings";
...
const LAST_ENABLED_PROJECT_GROUPING_MODE_KEY = "starcode:last-enabled-project-grouping-mode";

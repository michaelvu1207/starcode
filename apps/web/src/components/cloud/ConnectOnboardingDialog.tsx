...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@starcode/contracts";
...
/**
 * Post-sign-in onboarding wizard for starcode Connect. Opens on every in-session
 ...
 * account's starcode Connect environments so every device can be connected right
...
function ConfiguredConnectOnboardingDialog() {
  ...
  const applyPublishSelection = async () => {
    ...
    toastManager.add({
      type: "success",
      title: "starcode Connect enabled",
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up starcode Connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through starcode Connect."

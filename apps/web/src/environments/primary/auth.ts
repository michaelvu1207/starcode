...
import { EnvironmentHttpCommonError, PRIMARY_LOCAL_ENVIRONMENT_ID } from "@starcode/contracts";
import type { EnvironmentHttpCommonError as EnvironmentHttpCommonErrorType } from "@starcode/contracts";

...
import { resolveAssetUrl } from "@starcode/client-runtime/state/assets";
import type { AssetResource, EnvironmentId } from "@starcode/contracts";
...
export { resolveAssetUrl } from "@starcode/client-runtime/state/assets";

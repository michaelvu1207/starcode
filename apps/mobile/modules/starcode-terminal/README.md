# starcode Mobile Terminal Native Module
...
fork, with starcode's iOS 16 compatibility patch applied. `StarcodeTerminalView` owns a `libghostty` surface and
...
```bash
apps/mobile/modules/starcode-terminal/scripts/build-libghostty-ios16.sh
```
...
```bash
apps/mobile/modules/starcode-terminal/scripts/build-libghostty-android.sh
```

...
const customSprite = webIconSource.match(/const STARCODE_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error(
    "Could not read the starcode Pierre icon sprite from apps/web/src/pierre-icons.ts",
  );
}
...
const customIcons = {
  agents: "starcode-file-icon-agents",
  claude: "starcode-file-icon-claude",
  package: "starcode-file-icon-package-json",
  pnpm: "starcode-file-icon-pnpm",
  readme: "starcode-file-icon-readme",
  tsconfig: "starcode-file-icon-tsconfig",
};

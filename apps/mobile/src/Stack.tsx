...
function RootStackLayout(props: {
  ...
  // Presents the starcode Connect onboarding sheet after an in-session sign-in.
...
function NotFoundScreen() {
  ...
  return (
    ...
    >
      <Text className="text-3xl font-starcode-bold text-foreground" selectable>
        Route not found
      </Text>
      <Pressable
      ...
      >
        <Text className="text-base font-starcode-bold text-primary-foreground">Return home</Text>
      </Pressable>
    </ScrollView>
  );
}

import type { EnvironmentProject } from "@starcode/client-runtime/state/shell";
import { EnvironmentId, ProjectId, ProviderInstanceId } from "@starcode/contracts";
...
const projects: ReadonlyArray<EnvironmentProject> = [
  {
    ...
    id: ProjectId.make("starcode"),
    title: "starcode",
    workspaceRoot: "/workspace/starcode",

...
import { StarcodeKeyboardCommands } from "../../native/StarcodeKeyboardCommands";
import {
...
export function HardwareKeyboardCommandProvider({
  ...
  return (
    <StarcodeKeyboardCommands enabledCommands={enabledCommands} onCommand={onCommand}>
      {children}
    </StarcodeKeyboardCommands>
  );
}

    ...
    <Animated.View layout={LinearTransition.duration(250)} className="bg-card">
      ...
      >
        ...
        <View className="flex-1 gap-0.5">
          <Text
            className="text-base font-starcode-bold leading-snug text-foreground"
            numberOfLines={1}
          >
        ...
        >
          {props.environment.isRelayManaged ? (
            <Text className="text-sm text-foreground-muted">
              Managed by starcode Connect. Tunnel details update automatically.
            </Text>
          ) : (
            <>
              <View className="gap-1.5">
                <Text className="text-2xs font-starcode-bold tracking-[0.8px] uppercase text-foreground-muted">
                  Label
                </Text>
                <TextInput
          ...
          <View className="flex-row justify-end gap-2">
            {props.environment.isRelayManaged ? null : (
              ...
              >
                ...
                <Text className="text-xs font-starcode-bold tracking-[0.8px] uppercase text-primary-foreground">
                  Save
                </Text>
              </Pressable>
            )}

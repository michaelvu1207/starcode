import { type KnownTerminalSession } from "@starcode/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@starcode/contracts";
...
} from "@starcode/shared/terminalLabels";

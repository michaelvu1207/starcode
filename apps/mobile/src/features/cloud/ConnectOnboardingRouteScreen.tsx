...
import { reportAtomCommandResult, settlePromise } from "@starcode/client-runtime/state/runtime";
...
/**
 * Post-sign-in onboarding sheet for starcode Connect. Mobile never publishes
 * environments itself — it consumes ones published elsewhere — so this simply
 * surfaces the account's starcode Connect environments right after sign-in so every
        ...
        {isSignedIn ? (
          ...
          <View collapsable={false} className="rounded-[24px] bg-card p-5">
            <Text className="text-sm leading-normal text-foreground-muted">
              Sign in to your starcode account to set up starcode Connect.
            </Text>
          </View>
        )}

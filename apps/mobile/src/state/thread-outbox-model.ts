import { isTransportConnectionErrorMessage } from "@starcode/client-runtime/errors";
import type { EnvironmentShellStatus } from "@starcode/client-runtime/state/shell";
import {
  CommandId,
  EnvironmentId,
  IsoDateTime,

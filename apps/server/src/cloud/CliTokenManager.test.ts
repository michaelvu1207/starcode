import { readConnectAuthorizeRequest } from "@starcode/shared/connectAuth";
...
const TEST_ENV = {
  STARCODE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  STARCODE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  STARCODE_HOSTED_APP_URL: "https://hosted.example.test",
};

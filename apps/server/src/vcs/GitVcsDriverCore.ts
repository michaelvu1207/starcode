...
import { dedupeRemoteBranchesWithLocalMatches, normalizeGitRemoteUrl } from "@starcode/shared/git";
import { compactTraceAttributes } from "@starcode/shared/observability";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `starcode-git-trace2-${process.pid}-`,
    suffix: ".json",
  });

  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `starcode-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "starcode",
        GIT_AUTHOR_EMAIL: "starcode@users.noreply.github.com",
        GIT_COMMITTER_NAME: "starcode",
        GIT_COMMITTER_EMAIL: "starcode@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `starcode checkpoint ref=${input.checkpointRef}`;

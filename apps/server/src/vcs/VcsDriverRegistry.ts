...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@starcode/contracts";
import { VcsUnsupportedOperationError } from "@starcode/contracts";
...
>()("starcode/vcs/VcsDriverRegistry") {}

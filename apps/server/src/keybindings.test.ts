import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@starcode/contracts";
...
import { KeybindingsConfigError } from "@starcode/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "starcode-keybindings-test-",
        }),
      ),
    ),
  );

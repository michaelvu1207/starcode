 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@starcode/contracts";
...
>()("starcode/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}

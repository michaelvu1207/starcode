...
import { VcsProcessExitError, VcsProcessSpawnError } from "@starcode/contracts";
...
describe("GitHubCli.layer", () => {
  ...
  it.effect("keeps pull requests from gh versions without headRepository.nameWithOwner", () =>
    ...
    Effect.gen(function* () {
            ...
            JSON.stringify([
              {
                ...
                baseRefName: "main",
                headRefName: "starcode/codex-turn-mapping",
                state: "OPEN",
                mergedAt: null,
      ...
      const result = yield* gh.listOpenPullRequests({
        cwd: "/repo",
        headSelector: "starcode/codex-turn-mapping",
      });

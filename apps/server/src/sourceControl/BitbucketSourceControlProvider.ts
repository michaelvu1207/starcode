...
import { SourceControlProviderError, type ChangeRequest } from "@starcode/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set STARCODE_BITBUCKET_EMAIL and STARCODE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",

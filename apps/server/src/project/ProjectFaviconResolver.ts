...
>()("starcode/project/ProjectFaviconResolver") {}
...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* StarcodeProjectFileLoader.StarcodeProjectFileLoader;
  ...
  const resolvePath: ProjectFaviconResolver["Service"]["resolvePath"] = Effect.fn(
    ...
    // Explicit project configuration represents repository intent, so its
    // iconPath takes precedence over conventional framework locations.

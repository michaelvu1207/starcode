import { ProjectId } from "@starcode/contracts";
import { projectScriptRuntimeEnv, setupProjectScript } from "@starcode/shared/projectScripts";
...
>()("starcode/project/ProjectSetupScriptRunner") {}

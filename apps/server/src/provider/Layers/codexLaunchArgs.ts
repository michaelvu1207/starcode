import { tokenizeCliArgs } from "@starcode/shared/cliArgs";

export const STARCODE_CODEX_LAUNCH_ARGS_ENV = "STARCODE_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[STARCODE_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";

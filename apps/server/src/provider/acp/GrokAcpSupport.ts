import { type GrokSettings, ProviderDriverKind } from "@starcode/contracts";
...
import { normalizeModelSlug } from "@starcode/shared/model";
...
const STARCODE_CODE_OAUTH_REFERRER = "starcode";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: STARCODE_CODE_OAUTH_REFERRER,
    },
  };
}

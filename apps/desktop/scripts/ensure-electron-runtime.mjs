...
// oxlint-disable-next-line starcode/no-global-process-runtime -- Standalone repair script has no Effect runtime.
...
function installElectronRuntime(electronDir, version) {
  const tempDir = NodeFS.mkdtempSync(NodePath.join(NodeOS.tmpdir(), "starcode-electron-"));

...
export const DISCORD_PRESENCE_STATE_CHANNEL = "desktop:discord-presence-state";
export const DISCORD_PRESENCE_GET_STATE_CHANNEL = "desktop:discord-presence-get-state";
export const DISCORD_PRESENCE_SET_ENABLED_CHANNEL = "desktop:discord-presence-set-enabled";
export const DISCORD_PRESENCE_SET_SUMMARY_CHANNEL = "desktop:discord-presence-set-summary";
...
export const DISCOVER_FLEET_HOSTS_CHANNEL = "desktop:discover-fleet-hosts";
export const PREFLIGHT_FLEET_HOST_CHANNEL = "desktop:preflight-fleet-host";
...
export const PREVIEW_OPEN_PORT_BRIDGE_CHANNEL = "desktop:preview-open-port-bridge";
export const PREVIEW_CLOSE_PORT_BRIDGE_CHANNEL = "desktop:preview-close-port-bridge";

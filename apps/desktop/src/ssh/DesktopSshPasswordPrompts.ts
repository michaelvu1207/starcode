import type { DesktopSshPasswordPromptRequest } from "@starcode/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@starcode/contracts";
import type { SshPasswordRequest } from "@starcode/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `starcode window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@starcode/desktop/ssh/DesktopSshPasswordPrompts") {}
